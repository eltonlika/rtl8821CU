...
/* compress 512-bits */
static int sha256_compress(struct sha256_state_rtl_internal *md, unsigned char *buf)
{
	u32 S[8], W[64], t0, t1;
	u32 t;
	int i;
...
static void sha256_init(struct sha256_state_rtl_internal *md)
{
	md->curlen = 0;
	md->length = 0;
...
*/
static int sha256_process(struct sha256_state_rtl_internal *md, unsigned char *in,
			  unsigned long inlen)
{
	unsigned long n;
...
/**
   ...
   @return CRYPT_OK if successful
*/
static int sha256_done(struct sha256_state_rtl_internal *md, unsigned char *out)
{
	int i;
...
static int sha256_vector(size_t num_elem, u8 *addr[], size_t *len,
			 u8 *mac)
{
	struct sha256_state_rtl_internal ctx;
	size_t i;
